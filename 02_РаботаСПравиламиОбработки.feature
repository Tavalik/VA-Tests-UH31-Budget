...
Функционал: Проверка функционала работы с правилами расчета
...
Сценарий: 02.01 Создание отчета с ручным вводом - "ВА - Количество"
...
Сценарий: 02.02 Создание экземпляра отчета - "ВА - Количество"	
	...
	Когда открылось окно 'Экземпляр отчета ВА - Количество:  Валюта отображения:  RUB <Администрация УК> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>> *'
	И в табличном документе 'ПолеТабличногоДокументаМакет' я перехожу к ячейке "R6C2"
	И в табличном документе 'ПолеТабличногоДокументаМакет' я делаю двойной клик на текущей ячейке
	И я перехожу к следующему реквизиту
	Тогда открылось окно 'Раскрытие показателей: Период=Январь * г. \| Организация=Администрация УК \| Сценарий=ВА - Основной сценарий \| Проект= \| Валюты=RUB'
	И в таблице "РаскрытиеПоказателей" я нажимаю на кнопку с именем 'РаскрытиеПоказателейДобавить'
	И в таблице "РаскрытиеПоказателей" из выпадающего списка с именем "Номенклату" я выбираю по строке '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'
	И в таблице "РаскрытиеПоказателей" в поле с именем 'Значение' я ввожу текст '20,00000'
	И в таблице "РаскрытиеПоказателей" я нажимаю на кнопку с именем 'РаскрытиеПоказателейДобавить'
	И в таблице "РаскрытиеПоказателей" из выпадающего списка с именем "Номенклату" я выбираю по строке '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест'
	...
	И в таблице "РаскрытиеПоказателей" я нажимаю на кнопку с именем 'РаскрытиеПоказателейДобавить'
	И в таблице "РаскрытиеПоказателей" из выпадающего списка с именем "Номенклату" я выбираю по строке '1С:Управление холдингом 8'
	И в таблице "РаскрытиеПоказателей" я активизирую поле с именем "Значение"
	...
	И в таблице "РаскрытиеПоказателей" из выпадающего списка с именем "Номенклату" я выбираю по строке '1С:Корпорация'
	И в таблице "РаскрытиеПоказателей" я активизирую поле с именем "Значение"
	И в таблице "РаскрытиеПоказателей" в поле с именем 'Значение' я ввожу текст '7,00000'
	И в таблице "РаскрытиеПоказателей" я нажимаю на кнопку с именем 'РаскрытиеПоказателейДобавить'
	И в таблице "РаскрытиеПоказателей" из выпадающего списка с именем "Номенклату" я выбираю по строке '1С:ERP. Управление холдингом'
	И в таблице "РаскрытиеПоказателей" я активизирую поле с именем "Значение"
	...
	Тогда открылось окно 'Экземпляр отчета ВА - Количество:  Валюта отображения:  RUB <Администрация УК> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>> *'
	...
	И я жду закрытия окна 'Экземпляр отчета ВА - Количество:  Валюта отображения:  RUB <Администрация УК> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>> *' в течение 20 секунд

Сценарий: 02.03 Создание отчета с загрузкой из РС "ВА - Цена"
	...
	И в таблице "ДеревоПараметровОтбораБД" из выпадающего списка с именем "УточнениеСпособаОпределения" я выбираю по строке 'Программные продукты'
	И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
...
Сценарий: 02.04 Создание экземпляра отчета - "ВА - Цена"	
	...
	// Запишем документ
	Когда открылось окно 'Экземпляр отчета ВА - Цена:  Валюта отображения:  RUB <Администрация УК> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>> *'
	...
	// Закроем документ	
	И Я закрываю окно 'Экземпляр отчета ВА - Цена:  Валюта отображения:  RUB <Администрация УК> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>>'

Сценарий: 02.05 Создание отчета с рассчитываемыми показателями - "ВА - Продажи"

	// Ишем отчет с именем "ВА - Продажи"
	И В командном интерфейсе я выбираю 'Бюджетирование, отчетность и анализ' 'Виды и бланки отчетов'
	Тогда открылось окно 'Виды и бланки отчетов'
	И в таблице "СписокВидовОтчетов" я нажимаю на кнопку с именем 'СписокВидовОтчетовНайти'
	Тогда открылось окно 'Найти'
...
Сценарий: 02.06 Создание экземпляра отчета - "ВА - Продажи"	
	...
	// Запишем документ
	Когда открылось окно 'Экземпляр отчета ВА - Продажи:  Валюта отображения:  RUB <Администрация УК> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>> *'
	И я нажимаю на кнопку с именем 'ФормаЗаполнитьПоУмолчанию'
	И я нажимаю на кнопку с именем 'ФормаЗаписатьИПродолжить'
	...
	Когда открылось окно 'Экземпляр отчета ВА - Продажи:  Валюта отображения:  RUB <Администрация УК> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>>'
	И я нажимаю на кнопку с именем 'ЗаписатьИЗакрыть'
	И я жду закрытия окна 'Экземпляр отчета ВА - Продажи:  Валюта отображения:  RUB <Администрация УК> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>>' в течение 20 секунд
			
Сценарий: 02.07 Проверка поведения формы редактирования процедур
	...
	И в таблице "Определения" я перехожу к строке:
		...
		| 'ВернутьМассивОрганизацийОсуществляющихКонтрольПериметра()' |
	И в таблице "Определения" я выбираю текущую строку
	Тогда элемент формы с именем "ПолеТекстовогоДокументаПроцедура" стал равен ' ВернутьМассивОрганизацийОсуществляющихКонтрольПериметра()'
	И в поле с именем 'ПолеТекстовогоДокументаПроцедура' я ввожу текст ' '
...
Сценарий: 02.08 Проверка работы произвольных функций расчета
	...
	Тогда открылось окно 'Экземпляры отчетов'
	И в таблице "Список" я выбираю текущую строку
	Тогда открылось окно 'Экземпляр отчета ВА - Продажи:  Валюта отображения:  RUB <Администрация УК> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>>'
	И я нажимаю на кнопку с именем 'ФормаЗаполнитьПоУмолчанию'
	Тогда табличный документ "ПолеТабличногоДокументаМакет" равен:
		| 'ВА - Продажи(многопериодный)'                                    | ''               | ''     | ''      | ''                | ''           | ''      | ''             | ''           | ''      | ''           | ''           | ''      |
		| ''                                                                | ''               | ''     | ''      | ''                | ''           | ''      | ''             | ''           | ''      | ''           | ''           | ''      |
...
Сценарий: 02.09 Отображение экземпляра в валюте после расчетов
	...
	Тогда табличный документ "ПолеТабличногоДокументаМакет" равен:
		...
		| ''                                                                | 'Январь 2021 г.' | ''     | ''      | 'Февраль 2021 г.' | ''        | ''      | 'Март 2021 г.' | ''        | ''      | 'ИТОГО'      | ''        | ''      |
		| ''                                                                | 'Количество'     | 'Цена' | 'Сумма' | 'Количество'      | 'Цена'    | 'Сумма' | 'Количество'   | 'Цена'    | 'Сумма' | 'Количество' | 'Цена'    | 'Сумма' |
		| 'Номенклатура'                                                    | '0'              | '0'    | '0'     | '130'             | '134 095' | '0'     | '180'          | '149 587' | '0'     | '310'        | '283 683' | '0'     |
		| '1С:ERP. Управление холдингом '                                   | '0'              | '0'    | '0'     | '18'              | '43 364'  | '0'     | '28'           | '48 374'  | '0'     | '46'         | '91 738'  | '0'     |
		| '1С:Корпорация '                                                  | '0'              | '0'    | '0'     | '17'              | '45 588'  | '0'     | '27'           | '50 855'  | '0'     | '44'         | '96 443'  | '0'     |
		| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '0'              | '0'    | '0'     | '50'              | '13 343'  | '0'     | '60'           | '14 884'  | '0'     | '110'        | '28 227'  | '0'     |
		| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '0'              | '0'    | '0'     | '30'              | '4 003'   | '0'     | '40'           | '4 465'   | '0'     | '70'         | '8 468'   | '0'     |
		| '1С:Управление холдингом 8 '                                      | '0'              | '0'    | '0'     | '15'              | '27 798'  | '0'     | '25'           | '31 009'  | '0'     | '40'         | '58 807'  | '0'     |
	
	Когда открылось окно 'Экземпляр отчета ВА - Продажи:  Валюта отображения:  EUR <Администрация УК> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>> *'
	И я нажимаю на кнопку с именем 'ЗаписатьИЗакрыть'
	И я жду закрытия окна 'Экземпляр отчета ВА - Продажи:  Валюта отображения:  EUR <Администрация УК> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>> *' в течение 20 секунд

Сценарий: 02.10 Удаление версий при автоматическом расчете
	...
	Тогда открылось окно 'Экземпляр отчета ВА - Продажи:  Валюта отображения:  RUB <Администрация УК> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>>'
	И Я закрываю окно 'Экземпляр отчета ВА - Продажи:  Валюта отображения:  RUB <Администрация УК> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>>'
