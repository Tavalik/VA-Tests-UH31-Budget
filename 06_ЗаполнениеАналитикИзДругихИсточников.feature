...
Сценарий: 06.02 Создание экзмемпляра отчета "ВА - Данные для дополнения аналитик"
	...
	* Вводим значения показателей
		* Товарные категории	
			...
			Тогда открылось окно 'Раскрытие показателей: Период=Январь * г. \| Организация=Меркурий ООО \| Сценарий=ВА - Основной сценарий \| Проект= \| Товарные категории=Программные продукты \| Валюты=RUB'
		...
		* Товары
			...
			И в табличном документе 'ПолеТабличногоДокументаМакет' я делаю двойной клик на текущей ячейке
			Когда открылось окно 'Раскрытие показателей: Период=Январь * г. \| Организация=Меркурий ООО \| Сценарий=ВА - Основной сценарий \| Проект= \| Товарные категории=Программные продукты \| Валюты=RUB'
			И в таблице "РаскрытиеПоказателей" я нажимаю на кнопку с именем 'РаскрытиеПоказателейДобавить'
