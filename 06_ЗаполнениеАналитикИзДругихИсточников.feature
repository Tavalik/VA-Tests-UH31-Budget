...
Сценарий: 06.01 Создание вида отчета "ВА - Данные для дополнения аналитик"
...
Сценарий: 06.02 Создание экзмемпляра отчета "ВА - Данные для дополнения аналитик"
	...
	* Вводим значения показателей
		* Товарные категории	
			...
			Тогда открылось окно 'Раскрытие показателей: Период=Январь 2021 г. | Организация=Меркурий ООО | Сценарий=ВА - Основной сценарий | Товарные категории=Программные продукты | Валюты=RUB'
		...
		* Товары
			...
			И в табличном документе 'ПолеТабличногоДокументаМакет' я делаю двойной клик на текущей ячейке
			Когда открылось окно 'Раскрытие показателей: Период=Январь * г. \| Организация=Меркурий ООО \| Сценарий=ВА - Основной сценарий \| Товарные категории=Программные продукты \| Валюты=RUB'
			И в таблице "РаскрытиеПоказателей" я нажимаю на кнопку с именем 'РаскрытиеПоказателейДобавить'
...
Сценарий: 06.03 Создание вида отчета "ВА - Аналитики из полей других источников"
...
Сценарий: 06.04 Создание экзмемпляра отчета "ВА - Аналитики из полей других источников"
	...
	* Сравниваем результат	
		Тогда табличный документ "ПолеТабличногоДокументаМакет" равен:
			...
			| 'Апгрейд программных продуктов '                                  | '3'              | '6'               | '9'            | '18'         |
			| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '1'              | '2'               | '3'            | '6'          |
			| 'Апгрейд программных продуктов '                                  | '1'              | '2'               | '3'            | '6'          |
			| '1С:Управление холдингом 8 '                                      | '2'              | '4'               | '6'            | '12'         |
			| 'Апгрейд программных продуктов '                                  | '2'              | '4'               | '6'            | '12'         |
			| 'Рассчитываемый источник'                                         | '6'              | '12'              | '9'            | '27'         |
			| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '0'              | '0'               | '0'            | '9'          |
			| ' '                                                               | '0'              | '0'               | '0'            | '3'          |
			| 'Внедрение программных продуктов '                                | '1'              | '2'               | '0'            | '3'          |
			| 'Реализация программных продуктов '                               | '1'              | '2'               | '0'            | '3'          |
			| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '0'              | '0'               | '0'            | '9'          |
			| ' '                                                               | '0'              | '0'               | '0'            | '3'          |
			| 'Внедрение программных продуктов '                                | '1'              | '2'               | '0'            | '3'          |
			| 'Реализация программных продуктов '                               | '1'              | '2'               | '0'            | '3'          |
			| '1С:Управление холдингом 8 '                                      | '0'              | '0'               | '0'            | '9'          |
			| ' '                                                               | '0'              | '0'               | '0'            | '3'          |
			| 'Внедрение программных продуктов '                                | '1'              | '2'               | '0'            | '3'          |
			| 'Реализация программных продуктов '                               | '1'              | '2'               | '0'            | '3'          |
			...
			| 'Апгрейд программных продуктов '                                  | '1 500 000'      | '1 500 000'       | '1 553 800'    | '4 553 800'  |
...
Сценарий: 06.05 Проверка на рекурсивное вложение дополнения аналитик
