...
Сценарий: 05.03 Создание экземпляра отчета - "ВА - Нечисловые показатели (источник)" без записи 
	...
	* Сравниваем итоговый документ
		Тогда табличный документ "ПолеТабличногоДокументаМакет" равен:
			...
			| ''                                                                | 'Январь 2021 г.' | ''                | ''               | ''        | 'Февраль 2021 г.' | ''                | ''               | ''        | 'Март 2021 г.' | ''                | ''               | ''        | 'ИТОГО' | ''                | ''               | ''        |
			| ''                                                                | 'Цена'           | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' | 'Цена'            | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' | 'Цена'         | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' | 'Цена'  | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' |
			| 'Товары'                                                          | '6 030 000'      | '01.05.2021'      | 'Да'             | ''        | '6 633 000'       | '02.05.2021'      | 'Да'             | ''        | '6 633 000'    | '02.05.2021'      | 'Да'             | ''        | '0'     | '02.05.2021'      | ''               | ''        |
			| '1С:ERP. Управление холдингом '                                   | '1 950 000'      | '01.01.2021'      | 'Да'             | '000001'  | '2 145 000'       | '02.01.2021'      | 'Да'             | '2000001' | '2 145 000'    | '02.01.2021'      | 'Да'             | '2000001' | '0'     | '02.01.2021'      | ''               | ''        |
			...
			| '1С:Управление холдингом 8 '                                      | '1 250 000'      | '01.05.2021'      | 'Да'             | '000005'  | '1 375 000'       | '02.05.2021'      | 'Да'             | '2000005' | '1 375 000'    | '02.05.2021'      | 'Да'             | '2000005' | '0'     | '02.05.2021'      | ''               | ''        |
