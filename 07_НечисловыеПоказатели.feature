		...
		* Устанавливаем формулы расчета
			...
			* Источник
				* Цена
					...
					И из выпадающего списка с именем "РегистрСведенийБД" я выбираю точное значение 'ЦеныНоменклатуры'
...
Сценарий: 07.07 Создание экземпляра отчета - "ВА - Нечисловые показатели (приемник)"  
	...
	* Записываем документ и сверяем движения	
		...
		Тогда табличный документ "ОтчетТабличныйДокумент" равен по шаблону:
			...
			| 'Источник число'                   | ''                                                       | ''       | ''                                                               | ''                 | ''                | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'RUB'    | '6 030 000,00000'                                                | ''                 | ''                | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'USD'    | '81 244,50960'                                                   | ''                 | ''                | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'EUR'    | '66 631,96942'                                                   | ''                 | ''                | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'RUB'    | '6 633 000,00000'                                                | ''                 | ''                | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'USD'    | '89 183,55301'                                                   | ''                 | ''                | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'EUR'    | '73 755,64454'                                                   | ''                 | ''                | ''                |
			| '*'                                | 'Март 2021 г.'                                           | 'RUB'    | '6 633 000,00000'                                                | ''                 | ''                | ''                |
			| '*'                                | 'Март 2021 г.'                                           | 'USD'    | '89 149,03197'                                                   | ''                 | ''                | ''                |
			| '*'                                | 'Март 2021 г.'                                           | 'EUR'    | '74 795,33614'                                                   | ''                 | ''                | ''                |
			| 'ИсточникКод число'                | ''                                                       | ''       | ''                                                               | ''                 | ''                | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'RUB'    | '6 030 000,00000'                                                | ''                 | ''                | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'USD'    | '81 244,50960'                                                   | ''                 | ''                | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'EUR'    | '66 631,96942'                                                   | ''                 | ''                | ''                |
			...
			| '*'                                | 'Январь 2021 г.'                                         | 'USD'    | '81 244,50960'                                                   | ''                 | ''                | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'EUR'    | '66 631,96942'                                                   | ''                 | ''                | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'RUB'    | '13 266 000,00000'                                               | ''                 | ''                | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'USD'    | '178 367,10602'                                                  | ''                 | ''                | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'EUR'    | '147 511,28907'                                                  | ''                 | ''                | ''                |
			| '*'                                | 'Март 2021 г.'                                           | 'RUB'    | '19 899 000,00000'                                               | ''                 | ''                | ''                |
			| '*'                                | 'Март 2021 г.'                                           | 'USD'    | '267 447,09590'                                                  | ''                 | ''                | ''                |
			| '*'                                | 'Март 2021 г.'                                           | 'EUR'    | '224 386,00843'                                                  | ''                 | ''                | ''                |
			| 'ФормулыКод число'                 | ''                                                       | ''       | ''                                                               | ''                 | ''                | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'RUB'    | '1,00000'                                                        | ''                 | ''                | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'USD'    | '0,01347'                                                        | ''                 | ''                | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'EUR'    | '0,01105'                                                        | ''                 | ''                | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'RUB'    | '2,00000'                                                        | ''                 | ''                | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'USD'    | '0,02689'                                                        | ''                 | ''                | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'EUR'    | '0,02224'                                                        | ''                 | ''                | ''                |
			| '*'                                | 'Март 2021 г.'                                           | 'RUB'    | '3,00000'                                                        | ''                 | ''                | ''                |
			| '*'                                | 'Март 2021 г.'                                           | 'USD'    | '0,04032'                                                        | ''                 | ''                | ''                |
			| '*'                                | 'Март 2021 г.'                                           | 'EUR'    | '0,03383'                                                        | ''                 | ''                | ''                |
			| ''                                 | ''                                                       | ''       | ''                                                               | ''                 | ''                | ''                |
			...
			| 'Источник число'                   | ''                                                       | ''       | ''                                                               | ''                 | ''                | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'RUB'    | '1С:ERP. Управление холдингом'                                   | ''                 | '1 950 000,00000' | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'RUB'    | '1С:Корпорация'                                                  | ''                 | '2 050 000,00000' | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'RUB'    | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | ''                 | '600 000,00000'   | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'RUB'    | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | ''                 | '180 000,00000'   | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'RUB'    | '1С:Управление холдингом 8'                                      | ''                 | '1 250 000,00000' | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'USD'    | '1С:ERP. Управление холдингом'                                   | ''                 | '26 273,10012'    | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'USD'    | '1С:Корпорация'                                                  | ''                 | '27 620,43859'    | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'USD'    | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | ''                 | '8 084,03081'     | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'USD'    | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | ''                 | '2 425,20924'     | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'USD'    | '1С:Управление холдингом 8'                                      | ''                 | '16 841,73084'    | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'EUR'    | '1С:ERP. Управление холдингом'                                   | ''                 | '21 547,65180'    | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'EUR'    | '1С:Корпорация'                                                  | ''                 | '22 652,65959'    | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'EUR'    | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | ''                 | '6 630,04671'     | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'EUR'    | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | ''                 | '1 989,01401'     | ''                |
			| '*'                                | 'Январь 2021 г.'                                         | 'EUR'    | '1С:Управление холдингом 8'                                      | ''                 | '13 812,59731'    | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'RUB'    | '1С:ERP. Управление холдингом'                                   | ''                 | '2 145 000,00000' | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'RUB'    | '1С:Корпорация'                                                  | ''                 | '2 255 000,00000' | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'RUB'    | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | ''                 | '198 000,00000'   | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'RUB'    | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | ''                 | '660 000,00000'   | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'RUB'    | '1С:Управление холдингом 8'                                      | ''                 | '1 375 000,00000' | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'USD'    | '1С:ERP. Управление холдингом'                                   | ''                 | '28 840,45247'    | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'USD'    | '1С:Корпорация'                                                  | ''                 | '30 319,45003'    | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'USD'    | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | ''                 | '2 662,19561'     | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'USD'    | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | ''                 | '8 873,98537'     | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'USD'    | '1С:Управление холдингом 8'                                      | ''                 | '18 487,46953'    | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'EUR'    | '1С:ERP. Управление холдингом'                                   | ''                 | '23 851,32784'    | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'EUR'    | '1С:Корпорация'                                                  | ''                 | '25 074,47285'    | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'EUR'    | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | ''                 | '2 201,66103'     | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'EUR'    | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | ''                 | '7 338,87010'     | ''                |
			| '*'                                | 'Февраль 2021 г.'                                        | 'EUR'    | '1С:Управление холдингом 8'                                      | ''                 | '15 289,31271'    | ''                |
			| '*'                                | 'Март 2021 г.'                                           | 'RUB'    | '1С:ERP. Управление холдингом'                                   | ''                 | '2 145 000,00000' | ''                |
			| '*'                                | 'Март 2021 г.'                                           | 'RUB'    | '1С:Корпорация'                                                  | ''                 | '2 255 000,00000' | ''                |
