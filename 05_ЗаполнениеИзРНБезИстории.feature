...
Сценарий: 05.04 Создание экземпляра отчета - "ВА - Заполнение из РН (без истории)" с записью 
	...
	* Записываем документ, проверяем движения
		...
		И табличный документ "ОтчетТабличныйДокумент" равен по шаблону:
			...
			| '*'                                       | 'Январь 2021 г.'                                   | 'EUR'    | '34 476,24289'                     | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
			| '*'                                       | 'Февраль 2021 г.'                                  | 'RUB'    | '16 000 000,00000'                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
			| '*'                                       | 'Февраль 2021 г.'                                  | 'USD'    | '215 126,91816'                    | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
			...
			| '*'                                       | 'Февраль 2021 г.'                                  | 'USD'    | 'Внедрение программных продуктов'  | ''                 | '98 823,92803'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
			| '*'                                       | 'Февраль 2021 г.'                                  | 'USD'    | 'Апгрейд программных продуктов'    | ''                 | '46 386,74173'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
...
Сценарий: 05.07 Проверяем движения экземпляра отчета - "Заполнение из РН (без истории)"
	...
	* Проверяем движения	
		...
		И табличный документ "ОтчетТабличныйДокумент" равен по шаблону:
			...
			| '*'                                       | 'Февраль 2021 г.'                                                           | 'USD'    | '41 949,74904'                     | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
			...
			| '*'                                       | 'Февраль 2021 г.'                                                           | 'USD'    | 'Внедрение программных продуктов'  | ''                 | '31 462,31178'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
