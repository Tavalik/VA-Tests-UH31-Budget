	...
	* Записываем документ, проверяем движения
		...
		Если '$$РасширенныйАлгоритмРасчетаПоказателей$$' Тогда
			...
			Тогда табличный документ "ОтчетТабличныйДокумент" равен по шаблону:
				...
				| '*'                                       | 'Февраль 2021 г.'                                                           | 'USD'    | '215 126,91814'                    | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				...
				| '*'                                       | 'Февраль 2021 г.'                                                           | 'USD'    | 'Апгрейд программных продуктов'    | ''                 | '46 386,74172'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | 'Февраль 2021 г.'                                                           | 'USD'    | 'Внедрение программных продуктов'  | ''                 | '98 823,92802'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
