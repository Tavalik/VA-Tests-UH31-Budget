...
Сценарий: 05.07 Проверяем движения экземпляра отчета - "Заполнение из РН (без истории)"
	...
	* Проверяем, движения после сводной таблицы
		...
		Тогда табличный документ "ОтчетТабличныйДокумент" равен по шаблону:
			...
			| '*'                                       | 'Февраль 2021 г.'                                                           | 'USD'    | '41 949,74905'                     | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
			...
			| '*'                                       | 'Февраль 2021 г.'                                                           | 'USD'    | 'Апгрейд программных продуктов'    | ''                 | '0,00001'          | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
			| '*'                                       | 'Февраль 2021 г.'                                                           | 'USD'    | 'Внедрение программных продуктов'  | ''                 | '31 462,31179'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
