...
Функционал: Выгрузука бланков и загрузка экземпляров отчетов из Excel
...
Сценарий: 03.02 Создание отчета с группами и 6 аналитиками
	...
	И в таблице "НовыеСтроки" в поле с именем 'НовыеСтрокиНаименование' я ввожу текст 'Строка_Синтетика1'
	...
	И в таблице "НовыеСтроки" я завершаю редактирование строки
	И в таблице "НовыеСтроки" я нажимаю на кнопку с именем 'НовыеСтрокиДобавить'
	И в таблице "НовыеСтроки" в поле с именем 'НовыеСтрокиНаименование' я ввожу текст 'Строка_Синтетика2'
	И в таблице "НовыеСтроки" я завершаю редактирование строки
	И в таблице "НовыеСтроки" я нажимаю на кнопку с именем 'НовыеСтрокиДобавить'
	И в таблице "НовыеСтроки" в поле с именем 'НовыеСтрокиНаименование' я ввожу текст 'Группа_Аналитики'
	И в таблице "НовыеСтроки" я завершаю редактирование строки
	И в таблице "НовыеСтроки" я нажимаю на кнопку с именем 'НовыеСтрокиДобавить'
	И в таблице "НовыеСтроки" в поле с именем 'НовыеСтрокиНаименование' я ввожу текст 'Группа_Аналитики_1_2'
	И в таблице "НовыеСтроки" я завершаю редактирование строки
	И в таблице "НовыеСтроки" я нажимаю на кнопку с именем 'НовыеСтрокиДобавить'
	И в таблице "НовыеСтроки" в поле с именем 'НовыеСтрокиНаименование' я ввожу текст 'Строка_Аналитики1'
	И в таблице "НовыеСтроки" я завершаю редактирование строки
	И в таблице "НовыеСтроки" я нажимаю на кнопку с именем 'НовыеСтрокиДобавить'
	И в таблице "НовыеСтроки" в поле с именем 'НовыеСтрокиНаименование' я ввожу текст 'Строка_Аналитики2'
	И в таблице "НовыеСтроки" я завершаю редактирование строки
	И в таблице "НовыеСтроки" я нажимаю на кнопку с именем 'НовыеСтрокиДобавить'
	...
	Тогда открылось окно 'Конструктор отчета'
	И в табличном документе 'ПолеТабличногоДокументаМакет' я перехожу к ячейке "R8C1"
	И в табличном документе 'ПолеТабличногоДокументаМакет' я делаю двойной клик на текущей ячейке
	Тогда открылось окно 'Строка_Аналитики2 (Строки отчетов)'
	И из выпадающего списка с именем "Родитель" я выбираю по строке 'Группа_Аналитики_1_2'
	И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
	И я жду закрытия окна 'Строка_Аналитики2 (Строки отчетов) *' в течение 20 секунд
	Тогда открылось окно 'Конструктор отчета'
	И в табличном документе 'ПолеТабличногоДокументаМакет' я перехожу к ячейке "R8C1"
	И в табличном документе 'ПолеТабличногоДокументаМакет' я делаю двойной клик на текущей ячейке
	Тогда открылось окно 'Строка_Аналитики1 (Строки отчетов)'
	И из выпадающего списка с именем "Родитель" я выбираю по строке 'Группа_Аналитики_1_2'
	И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
	И я жду закрытия окна 'Строка_Аналитики1 (Строки отчетов) *' в течение 20 секунд
	Тогда открылось окно 'Конструктор отчета'
	...
	И из выпадающего списка с именем "Родитель" я выбираю по строке 'Группа_Аналитики'
	И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
	...
	И в табличном документе 'ПолеТабличногоДокументаМакет' я делаю двойной клик на текущей ячейке
	Тогда открылось окно 'Строка_Синтетика2 (Строки отчетов)'
	И из выпадающего списка с именем "Родитель" я выбираю по строке 'Группа_Синтетика'
	И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
	И я жду закрытия окна 'Строка_Синтетика2 (Строки отчетов) *' в течение 20 секунд
	Тогда открылось окно 'Конструктор отчета'
	И в табличном документе 'ПолеТабличногоДокументаМакет' я перехожу к ячейке "R12C1"
	...
	Тогда табличный документ "ПолеТабличногоДокументаМакет" равен:
		...
		| 'Строка_Аналитики1'         | 'Контрагенты' | ''                      | ''                   | ''             | ''           | ''                          | ''                      | ''          |
		| 'Строка_Аналитики2'         | 'Контрагенты' | 'Договоры контрагентов' | ''                   | ''             | ''           | ''                          | ''                      | ''          |
		| 'Группа_Аналитики_6'        | ''            | ''                      | ''                   | ''             | ''           | ''                          | ''                      | ''          |
...
Сценарий: 03.03 Создание многопериодного бланка отчета и выгузка в Excel
	...
	// Создаем элемент справочника "Внешняя ИБ"
	И из выпадающего списка с именем "ВнешняяИБ" я выбираю по строке 'ВА - Импорт из Excel'
	И в поле с именем 'ИмяФайлаВыгрузки' я ввожу текст '$КаталогПроекта$\Макеты\ВА_ИмпортExcel_Шаблон.xls'
	...
	//И я буду выбирать внешний файл "$КаталогПроекта$\Макеты\ВА_ИмпортExcel_Шаблон.xls"
	//И я нажимаю кнопку выбора у поля с именем "ПутьКДокументу1"
	И в поле с именем 'ПутьКДокументу1' я ввожу текст '$КаталогПроекта$\Макеты\ВА_ИмпортExcel_Шаблон.xls'
	//Тогда открылось окно 'Сравнение табличных документов'
	//И я буду выбирать внешний файл "$КаталогПроекта$\Макеты\ВА_ИмпортExcel_Шаблон.mxl"
	//И я нажимаю кнопку выбора у поля с именем "ПутьКДокументу2"
	И в поле с именем 'ПутьКДокументу2' я ввожу текст '$КаталогПроекта$\Макеты\ВА_ИмпортExcel_Шаблон.mxl'
	//Тогда открылось окно 'Сравнение табличных документов'
	И я перехожу к закладке с именем "СтраницаИсключения"
	И в таблице "СвойстваИсключения" я нажимаю на кнопку с именем 'СвойстваИсключенияДобавить'
	И в таблице "СвойстваИсключения" в поле с именем 'СвойстваИсключенияСвойство' я ввожу текст 'ШиринаКолонки'
	И в таблице "СвойстваИсключения" я завершаю редактирование строки
	И в таблице "СвойстваИсключения" я нажимаю на кнопку с именем 'СвойстваИсключенияДобавить'
	И в таблице "СвойстваИсключения" в поле с именем 'СвойстваИсключенияСвойство' я ввожу текст 'ВысотаСтроки'
	И в таблице "СвойстваИсключения" я завершаю редактирование строки
...
Сценарий: 03.04 Создание экземпляра отчета - "ВА - ИмпортExcel"	и загрузка из файла
	...
	Тогда табличный документ "ПолеТабличногоДокументаМакет" равен:
		...
		| 'Строка_Синтетика1'                | ''                         | ''                                   | ''                                | ''                          | ''                        | ''                                       | ''                    | '0'              | '0'     | '0'               | '0'     | '0'            | '0'     |
		| 'Группа_Синтетика'                 | ''                         | ''                                   | ''                                | ''                          | ''                        | ''                                       | ''                    | '0'              | '0'     | '0'               | '0'     | '0'            | '0'     |
		| 'Строка_Синтетика2'                | ''                         | ''                                   | ''                                | ''                          | ''                        | ''                                       | ''                    | '0'              | '0'     | '0'               | '0'     | '0'            | '0'     |
		| 'Группа_Аналитики'                 | ''                         | ''                                   | ''                                | ''                          | ''                        | ''                                       | ''                    | '0'              | '0'     | '0'               | '0'     | '0'            | '0'     |
		| 'Группа_Аналитики_1_2'             | ''                         | ''                                   | ''                                | ''                          | ''                        | ''                                       | ''                    | '0'              | '0'     | '0'               | '0'     | '0'            | '0'     |
		| 'Строка_Аналитики1'                | ''                         | ''                                   | ''                                | ''                          | ''                        | ''                                       | ''                    | '0'              | '0'     | '0'               | '0'     | '0'            | '0'     |
		| 'Строка_Аналитики2'                | ''                         | ''                                   | ''                                | ''                          | ''                        | ''                                       | ''                    | '0'              | '0'     | '0'               | '0'     | '0'            | '0'     |
	...
	//И я буду выбирать внешний файл "$КаталогПроекта$\Макеты\ВА_ИмпортExcel_Меркурий.xls"
	//И я нажимаю кнопку выбора у поля с именем "ПутьКФайлу"
	И в поле с именем 'ПутьКФайлу' я ввожу текст '$КаталогПроекта$\Макеты\ВА_ИмпортExcel_Меркурий.xls'
	Тогда открылось окно 'Выбор способа заполнения'
...
Сценарий: 03.05 Повторная загрузка данных из файла		
	...
	Тогда открылось окно 'Выбор способа заполнения'
	И я перехожу к закладке с именем "ГруппаСтраницаИмпортИзФайла"
	//И я буду выбирать внешний файл "$КаталогПроекта$\Макеты\ВА_ИмпортExcel_Меркурий_2.xls"
	//И я нажимаю кнопку выбора у поля с именем "ПутьКФайлу"
	И в поле с именем 'ПутьКФайлу' я ввожу текст '$КаталогПроекта$\Макеты\ВА_ИмпортExcel_Меркурий_2.xls'	
	Тогда открылось окно 'Выбор способа заполнения'
	И я нажимаю на кнопку с именем 'ЗаполнитьОтчет'
	Тогда открылось окно 'Экземпляр отчета ВА - ИмпортExcel:  Валюта отображения:  RUB <Меркурий ООО> <> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>> *'
