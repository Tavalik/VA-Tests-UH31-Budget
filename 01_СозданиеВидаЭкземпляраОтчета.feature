...
Сценарий: 01.08 Создание экземпляра отчета
	...
	* Сравниваем с эталонным макетом
		...
		//++ ДОДЕЛАТЬ: временно отключаю проверку
...
Сценарий: 01.21 Тестируем кнопки пересчета показателей
	...
	* Сохраним вариант
		...
		И Я запоминаю значение выражения '"ВА - " + СтрЗаменить(Новый УникальныйИдентификатор, "-", "")' в переменную "УИД"
		И в поле с именем 'НаименованиеНастройки' я ввожу значение переменной "УИД"
		И я нажимаю на кнопку с именем 'Применить'
		Если открылось окно '1С:Предприятие' Тогда
			И я нажимаю на кнопку с именем 'Button0'
		Тогда открылось окно 'Сводная таблица: ВА - *'
		И Я закрываю окно 'Сводная таблица: ВА - *'
