...
Функционал: Проверка создание видов отчетов с полным набором аналитик
...
Сценарий: 01.07 Создание экземпляра отчета
	...
	И я буду выбирать внешний файл "$КаталогПроекта$\Макеты\ВА_ВидОтчетаСАналитиками_Администрация_УК.mxl" 
	И я нажимаю на кнопку с именем 'Button0'
	И Пауза 30
	...
	И я жду закрытия окна 'Экземпляр отчета ВА - ВидОтчетаСАналитиками:  Валюта отображения:  RUB <Администрация УК> <ВА - Основной проект> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>>' в течение 60 секунд
...
Сценарий: 01.10 Отображение в дополнительной валюте
	...
	Тогда открылось окно 'Экземпляр отчета ВА - ВидОтчетаСАналитиками:  Валюта отображения:  USD <Бухгалтерия УК> <ВА - Основной проект> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>> *'
	Дано Табличный документ "ПолеТабличногоДокументаМакет" равен макету "Макеты\ВА_ВидОтчетаСАналитиками_Администрация_УК_USD"
	И Я закрываю окно 'Экземпляр отчета ВА - ВидОтчетаСАналитиками:  Валюта отображения:  USD <Бухгалтерия УК> <ВА - Основной проект> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>> *'
	Тогда открылось окно '1С:Предприятие'
...
Сценарий: 01.16 Изменение отчета при выводе в тысячах
	...
	Тогда открылось окно 'Экземпляр отчета ВА - ВидОтчетаСАналитиками:  Валюта отображения:  RUB <Бухгалтерия УК> <ВА - Основной проект> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>> *'
	И я нажимаю на кнопку с именем 'ЗаписатьИЗакрыть'
	И я жду закрытия окна 'Экземпляр отчета ВА - ВидОтчетаСАналитиками:  Валюта отображения:  RUB <Бухгалтерия УК> <ВА - Основной проект> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>> *' в течение 20 секунд
	...
	Дано Табличный документ "ПолеТабличногоДокументаМакет" равен макету "Макеты\ВА_ВидОтчетаСАналитиками_Бухгалтерия_УК"
