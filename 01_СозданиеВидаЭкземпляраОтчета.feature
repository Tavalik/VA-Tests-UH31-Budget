...
Сценарий: 01.01 Создание вида отчета
	...
	* Записываем документ
		...
		И я жду закрытия окна 'ВА - Ручной ввод по всем аналитикам (Виды отчетов)' в течение 20 секунд
...
Сценарий: 01.03 Работа в контрукторе отчета - Настройка структуры отчета
	...
	* Открываем конструктор
		...
		Тогда открылось окно 'Найти'
		И из выпадающего списка с именем "Pattern" я выбираю по строке 'ВАРучнойВводПоВсемАналитикам'
		И я нажимаю на кнопку с именем 'Find'
		Тогда открылось окно 'Виды и бланки отчетов'
		И в таблице "СписокВидовОтчетов" я нажимаю на кнопку с именем 'ОткрытьКонструктор'
...
Сценарий: 01.07 Создание бланка вида отчета
	...
	* Создаем Бланк экземпляра отчета
		...
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Бланк ВА - Ручной ввод по всем аналитикам вида отчета: ВА - Ручной ввод по всем аналитикам'
		...
		Тогда открылось окно 'Бланк ВА - Ручной ввод по всем аналитикам вида отчета: ВА - Ручной ввод по всем аналитикам *'
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна 'Бланк ВА - Ручной ввод по всем аналитикам вида отчета: ВА - Ручной ввод по всем аналитикам *' в течение 5 секунд
	...
	* Формируем Бланк многопериодного экземпляра отчета
		И я жду закрытия окна 'Бланк сводной таблицы: ВА - Ручной ввод по всем аналитикам(cводная таблица)' в течение 5 секунд
		Тогда открылось окно 'Виды и бланки отчетов'
		И в таблице "Список" я перехожу к строке:
			| 'Наименование'                               |
			| 'ВА - Ручной ввод по всем аналитикам(многопериодный)' |
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Бланк ВА - Ручной ввод по всем аналитикам(многопериодный) вида отчета: ВА - Ручной ввод по всем аналитикам'
...
Сценарий: 01.09 Копирование экземпляра отчета
...
Сценарий: 01.10 Сохранение настроек формы списка экземпляров отчетов
...
Сценарий: 01.11 Отображение в дополнительной валюте
...
Сценарий: 01.12 Очистка показателей отчета
...
Сценарий: 01.13 Открытие версии
...
Сценарий: 01.14 Удаление версии
...
Сценарий: 01.15 Сравнение версий
...
Сценарий: 01.16 Сворачивание до версии	
...
Сценарий: 01.17 Изменение отчета при выводе в тысячах
...
Сценарий: 01.19 Созадем бланк сводной таблицы
	...
	* Создадим бланк сводной таблицы
		Когда открылось окно 'Виды и бланки отчетов'
		И в таблице "Список" я перехожу к строке:
			| 'Наименование'                                         |
			| 'ВА - Ручной ввод по всем аналитикам(cводная таблица)' |
...
Сценарий: 01.20 Переходим в режим отображения данных
	...
	* Меняем показатели
		* Первый показатель
			...
			И в табличном документе 'ПолеТабличногоДокументаМакет' я делаю двойной клик на текущей ячейке
			Тогда открылось окно 'Раскрытие показателей: Период=Январь * г. \| Организация=Венера ООО \| Сценарий=ВА - Основной сценарий \| Проект=ВА - Основной проект \| Товарные категории=Программные продукты \| Номенклатура=1С:Управление холдингом * \| Контрагенты=ООО "Ганимед" \| Договоры=Ганимед-001 от * \| Валюты=RUB'
			И в таблице "РаскрытиеПоказателей" я выбираю текущую строку
			...
			И в табличном документе 'ПолеТабличногоДокументаМакет' я делаю двойной клик на текущей ячейке
			Когда открылось окно 'Раскрытие показателей: Период=Январь * г. \| Организация=Венера ООО \| Сценарий=ВА - Основной сценарий \| Проект=ВА - Основной проект \| Товарные категории=Программные продукты \| Номенклатура=1С:Управление холдингом * \| Контрагенты=ООО "Ганимед" \| Договоры=Ганимед-001 от * \| Валюты=RUB (только просмотр)'
		...
		* Отменяем измененное значение
			...
			И в табличном документе 'ПолеТабличногоДокументаМакет' я перехожу к ячейке "R21C3"
			И в табличном документе 'ПолеТабличногоДокументаМакет' я делаю двойной клик на текущей ячейке
			Тогда открылось окно 'Раскрытие показателей: Период=Январь * г. \| Организация=Венера ООО \| Сценарий=ВА - Основной сценарий \| Проект=ВА - Основной проект \| Товарные категории=Программные продукты \| Номенклатура=1С:Управление холдингом * \| Контрагенты=ООО "Ганимед" \| Договоры=Ганимед-001 от * \| Валюты=RUB (только просмотр)'
			Тогда таблица "РаскрытиеПоказателей" стала равной:
				| 'Статьи ДДС'                       | 'ВА - Ручной ввод по всем аналитикам.СтрокаАналитика5 сумма' |
		...
		* Показатель с валютной аналитикой
			...
			И в табличном документе 'ПолеТабличногоДокументаМакет' я делаю двойной клик на текущей ячейке
			Тогда открылось окно 'Раскрытие показателей: Период=Январь * г. \| Организация=Венера ООО \| Сценарий=ВА - Основной сценарий \| Проект=ВА - Основной проект \| Товарные категории=Программные продукты \| Номенклатура=1С:Управление холдингом * \| Контрагенты=ООО "Ганимед" \| Договоры=Ганимед-001 от * \| Валюты=EUR \| Валюты=RUB'
			...
			И в табличном документе 'ПолеТабличногоДокументаМакет' я делаю двойной клик на текущей ячейке
			Тогда открылось окно 'Раскрытие показателей: Период=Январь * г. \| Организация=Венера ООО \| Сценарий=ВА - Основной сценарий \| Проект=ВА - Основной проект \| Товарные категории=Программные продукты \| Номенклатура=1С:Управление холдингом * \| Контрагенты=ООО "Ганимед" \| Договоры=Ганимед-001 от * \| Валюты=RUB \| Валюты=RUB'
			И в таблице "РаскрытиеПоказателей" я активизирую поле с именем "Значение"
			И в таблице "РаскрытиеПоказателей" я выбираю текущую строку
			И в таблице "РаскрытиеПоказателей" в поле с именем 'Значение' я ввожу текст '10 000,00000'
			И я нажимаю на кнопку с именем 'ФормаКнопкаОК'
...
Сценарий: 01.21 Тестируем кнопки пересчета показателей
	...
	* Кнопки копирования показателей
		...
		И в табличном документе 'ПолеТабличногоДокументаМакет' я перехожу к ячейке "R20C3"
	...
	* Тестируем стрелки
		Тогда открылось окно 'Сводная таблица: ВА - Ручной ввод по всем аналитикам(cводная таблица)( Основной) *'
		И в табличном документе 'ПолеТабличногоДокументаМакет' я перехожу к ячейке "R5C2:R32C2"
		И я нажимаю на кнопку с именем 'СкопироватьДанныеПоСтроке'
		И я нажимаю на кнопку с именем 'Применить'
		// ДОДЕЛАТЬ: СТРЕЛКУ ВНИЗ

	* Тестируем кнопки изменения показателей
		// ДОДЕЛАТЬ: Кнопки изменения показателей

	* Настройки разрядности отображения показателей
		// ДОДЕЛАТЬ: Тестируем кнопки рязрядности		
	...
	* Сравниваем результат
		Тогда открылось окно 'Сводная таблица: ВА - Ручной ввод по всем аналитикам(cводная таблица)( Основной) *'				
		Дано Табличный документ "ПолеТабличногоДокументаМакет" равен макету "Макеты\ВА_ВидОтчетаСАналитиками_СводнаяТаблица3.mxl"			
					
	* Сохраним вариант
		И я нажимаю на кнопку с именем 'СохранитьТекущийВариантТаблицыКак'
		Тогда открылось окно 'Сохранение варианта сводной таблицы'
		И в поле с именем 'НаименованиеНастройки' я ввожу текст 'ВА - Вариант №2'
		И я нажимаю на кнопку с именем 'Применить'
		Если открылось окно '1С:Предприятие' Тогда
			И я нажимаю на кнопку с именем 'Button0'
		Тогда открылось окно 'Сводная таблица: ВА - Вариант №2*'
		И Я закрываю окно 'Сводная таблица: ВА - Вариант №2*'
	...
	* Загрузим вариант
		...
		И из выпадающего списка с именем "ВариантСводнойТаблицы" я выбираю по строке 'ВА - Вариант №2'
		Тогда открылось окно 'Сводная таблица: ВА - Вариант №2'
		И я нажимаю на кнопку с именем 'ОбновитьДанныеТаблицы1'
		Когда открылось окно 'Сводная таблица: ВА - Вариант №2'
		Дано Табличный документ "ПолеТабличногоДокументаМакет" равен макету "Макеты\ВА_ВидОтчетаСАналитиками_СводнаяТаблица3.mxl"
		И Я закрываю окно 'Сводная таблица: ВА - Вариант №2'
