...
Сценарий: 00.13 Создание Номенклатуры
	...
	И Я создаю номенклатуру с именем "1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)" родителем "ВА - Номенклатура" видом номенклатуры "ВА - Номенклатура" артикулом "2900001916059" товарной категорией "Программные продукты"
	И Я создаю номенклатуру с именем "1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест" родителем "ВА - Номенклатура" видом номенклатуры "ВА - Номенклатура" артикулом "4601546106674" товарной категорией "Программные продукты"
	И Я создаю номенклатуру с именем "1С:Управление холдингом 8" родителем "ВА - Номенклатура" видом номенклатуры "ВА - Номенклатура" артикулом "2900001871389" товарной категорией "Программные продукты"
	И Я создаю номенклатуру с именем "1С:Корпорация" родителем "ВА - Номенклатура" видом номенклатуры "ВА - Номенклатура" артикулом "2900001871419" товарной категорией "Программные продукты"
	И Я создаю номенклатуру с именем "1С:ERP. Управление холдингом" родителем "ВА - Номенклатура" видом номенклатуры "ВА - Номенклатура" артикулом "2900001970198" товарной категорией "Программные продукты"
