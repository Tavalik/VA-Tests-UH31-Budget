...
Сценарий: Я устанавливаю отбор сводной таблицы "ИмяОтбора" со значением "ЗначениеОтбора"
	...
	Если элемент "ИмяОтбора" присутствует на форме Тогда
		И из выпадающего списка с именем "ИмяОтбора" я выбираю точное значение "ЗначениеОтбора"
...
Сценарий: Я устанавливаю отборы сводной таблицы: дата начала "ОтборДатаНачала", дата конца "ОтборДатаКонца", валюта "ОтборВалюта", сценарий "ОтборСценарий", организация "ОтборОрганизация"	
	...
	И из выпадающего списка с именем "ВалютаОтображения" я выбираю точное значение "ОтборВалюта"
	И из выпадающего списка с именем "Элемент_Сценарий" я выбираю точное значение "ОтборСценарий"
	И из выпадающего списка с именем "Элемент_Организация" я выбираю точное значение "ОтборОрганизация"
	И я нажимаю на кнопку с именем 'ОбновитьДанныеТаблицы1'
	И Пауза 1
