...
Сценарий: 11.02 Редактируем сводную таблицу "ВА - Количество (ФА)"
	...
	* Заполняем сводную таблицу
		* Количество
			...
			И в таблице "РаскрытиеПоказателей" я нажимаю на кнопку с именем 'РаскрытиеПоказателейДобавить'
			И в таблице "РаскрытиеПоказателей" из выпадающего списка с именем "ВА0Номенкл" я выбираю точное значение '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест'
			...
			И в таблице "РаскрытиеПоказателей" я нажимаю на кнопку с именем 'РаскрытиеПоказателейДобавить'
			И в таблице "РаскрытиеПоказателей" из выпадающего списка с именем "ВА0Номенкл" я выбираю точное значение '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'
			И в таблице "РаскрытиеПоказателей" я активизирую поле с именем "Значение"
	...
	* Сравниваем результат	
		Тогда табличный документ "ПолеТабличногоДокументаМакет" равен:
			| 'ВА - Количество (ФА)(cводная таблица)'                          | 'Январь 2021 г.' | ''            | ''      | 'Февраль 2021 г.' | ''            | ''      | 'Март 2021 г.' | ''            | ''      | 'Итого'      | ''            | ''       |
			| 'ВА - Количество (ФА)(cводная таблица)'                          | 'Количество'     | 'Коэффициент' | 'Итог'  | 'Количество'      | 'Коэффициент' | 'Итог'  | 'Количество'   | 'Коэффициент' | 'Итог'  | 'Количество' | 'Коэффициент' | 'Итог'   |
			| 'Итог'                                                           | '150'            | '10'          | '1 500' | '300'             | '20'          | '6 000' | '450'          | '10'          | '4 500' | '900'        | '40'          | '12 000' |
			| 'Товары'                                                         | '150'            | '10'          | '300'   | '300'             | '20'          | '1 200' | '450'          | '10'          | '900'   | '900'        | '40'          | '2 400'  |
			| '1С:ERP. Управление холдингом'                                   | '10'             | '2'           | '20'    | '20'              | '4'           | '80'    | '30'           | '2'           | '60'    | '60'         | '8'           | '160'    |
			| '1С:Корпорация'                                                  | '20'             | '2'           | '40'    | '40'              | '4'           | '160'   | '60'           | '2'           | '120'   | '120'        | '8'           | '320'    |
			| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '30'             | '2'           | '60'    | '60'              | '4'           | '240'   | '90'           | '2'           | '180'   | '180'        | '8'           | '480'    |
			| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '40'             | '2'           | '80'    | '80'              | '4'           | '320'   | '120'          | '2'           | '240'   | '240'        | '8'           | '640'    |
			| '1С:Управление холдингом 8'                                      | '50'             | '2'           | '100'   | '100'             | '4'           | '400'   | '150'          | '2'           | '300'   | '300'        | '8'           | '800'    |
	...
	* Сравниваем результат
		Тогда табличный документ "ПолеТабличногоДокументаМакет" равен:
			...
			| 'Товары'                                | ''                             | '0,00081'        | '0,00005'     | '0,00162' | '0,00161'         | '0,00011'     | '0,00645' | '0,00242'      | '0,00005'     | '0,00484' | '0,00484'           | '0,00022'     | '0,01291' | '0,00484'    | '0,00022'     | '0,01291' |
			| ''                                      | '1С:ERP. Управление холдингом' | '0,00013'        | '0,00003'     | '0,00027' | '0,00027'         | '0,00005'     | '0,00108' | '0,00040'      | '0,00003'     | '0,00081' | '0,00081'           | '0,00011'     | '0,00215' | '0,00081'    | '0,00011'     | '0,00215' |
			| ''                                      | '1С:Управление холдингом 8'    | '0,00067'        | '0,00003'     | '0,00135' | '0,00134'         | '0,00005'     | '0,00538' | '0,00202'      | '0,00003'     | '0,00403' | '0,00403'           | '0,00011'     | '0,01076' | '0,00403'    | '0,00011'     | '0,01076' |
